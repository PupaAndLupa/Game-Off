...
public class ChooseCharacterOnLoad : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject one = Instantiate(class1, new Vector3(-3.75f, 0.2f, 0f), Quaternion.identity, null);
        ...
        GameObject two = Instantiate(class2, new Vector3(3.75f, 0.2f, 0f), Quaternion.identity, null);
